...
enum class EquipmentType(
    ...
    BOW(
        "Bow", ItemFactory.fromEncoding("minecraft:bow"), mapOf(
    ...
    SPEAR(
        "Spear", ItemFactory.fromEncoding("minecraft:iron_shovel"), mapOf(
    ...
    WAND(
        "Wand", ItemFactory.fromEncoding("minecraft:stick"), mapOf(
    ...
    DAGGER(
        "Dagger", ItemFactory.fromEncoding("minecraft:shears"), mapOf(
    ...
    RELIK(
        "Relik", ItemFactory.fromEncoding("minecraft:stone_shovel#7"), mapOf(
    ...
    HELMET(
        "Helmet", ItemFactory.fromEncoding("minecraft:diamond_helmet"), mapOf(
    ...
    CHESTPLATE(
        "Chestplate", ItemFactory.fromEncoding("minecraft:diamond_chestplate"), mapOf(
    ...
    LEGGINGS(
        "Leggings", ItemFactory.fromEncoding("minecraft:diamond_leggings"), mapOf(
    ...
    BOOTS(
        "Boots", ItemFactory.fromEncoding("minecraft:diamond_boots"), mapOf(
    ...
    RING(
        "Ring", ItemFactory.fromEncoding("minecraft:flint_and_steel#2"), mapOf(
    ...
    NECKLACE(
        "Necklace", ItemFactory.fromEncoding("minecraft:flint_and_steel#19"), mapOf(
    ...
    BRACELET(
        "Bracelet", ItemFactory.fromEncoding("minecraft:flint_and_steel#36"), mapOf(
    ...
    TOME(
        "Mastery Tome", ItemFactory.fromEncoding("minecraft:enchanted_book"), mapOf(
            "tome" to ItemFactory.fromEncoding("minecraft:enchanted_book")
        )
    ),
    CHARM(
        "Charm", ItemFactory.fromEncoding("minecraft:totem_of_undying"), mapOf(
