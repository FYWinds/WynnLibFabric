...
class AdvanceSearchPaneWidget<T : BaseItem>(
    private val screen: DictionaryScreen<T>,
    ...
    override fun render(matrices: MatrixStack?, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        client.textRenderer.draw(
            matrices, Translations.UI_ADVANCE_SEARCH.translate(),
